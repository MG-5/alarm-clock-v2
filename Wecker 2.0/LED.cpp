...
void LED(RGB_vector vector) { LED(vector.red, vector.green, vector.blue); }
...
void LED_with_factor(RGB_vector &vector) { LED_with_factor(vector.red, vector.green, vector.blue); }
...
void fadeToColor(RGB_vector &color) { fadeToColor(color.red, color.green, color.blue); }
